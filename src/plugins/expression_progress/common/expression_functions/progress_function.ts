...
export const strings = {
  ...
  args: {
    barColor: i18n.translate('expressionProgress.functions.progress.args.barColorHelpText', {
      defaultMessage: 'The color of the background bar.',
    }),
    barWeight: i18n.translate('expressionProgress.functions.progress.args.barWeightHelpText', {
      defaultMessage: 'The thickness of the background bar.',
    }),
    font: i18n.translate('expressionProgress.functions.progress.args.fontHelpText', {
      defaultMessage:
    ...
    label: i18n.translate('expressionProgress.functions.progress.args.labelHelpText', {
      defaultMessage:
    ...
    shape: i18n.translate('expressionProgress.functions.progress.args.shapeHelpText', {
    ...
    valueColor: i18n.translate('expressionProgress.functions.progress.args.valueColorHelpText', {
      defaultMessage: 'The color of the progress bar.',
    }),
    valueWeight: i18n.translate('expressionProgress.functions.progress.args.valueWeightHelpText', {
...
export const errors = {
  invalidMaxValue: (max: number) =>
    new Error(
      i18n.translate('expressionProgress.functions.progress.invalidMaxValueErrorMessage', {
  ...
  invalidValue: (value: number, max: number = 1) =>
    new Error(
      i18n.translate('expressionProgress.functions.progress.invalidValueErrorMessage', {
        defaultMessage:
