...
export * from './config';
export { IEventLogService } from './event_log';
...
export { IRuleDataClient, RuleDataClientConstructorOptions } from './rule_data_client/types';
...
} from './utils/create_persistence_rule_type_factory';
